...
Traditional cybersecurity frameworks rely primarily on recognizing attack patterns. While effective against catalogued threats, these systems struggle against new attacks [5][10]. AI introduces a strong shift in defense, making it proactive instead of being reactive, enabling systems to anticipate and stop attacks before they happen.

By utilizing big data analytics, AI constantly monitors large-scale network environments in real time in order to understand how the system normally operates. Unlike traditional systems with fixed threat databases, AI-driven approaches offer capabilities like dynamic threat adaptation and real-time intrusion detection [1][2]. This ability allows Intrusion Detection Systems to detect signs of attacks; A recent analysis shows that ML-based IDS improved detection accuracy by 17-35\% compared to traditional systems [8].

Additionally, machine learning has become essential to threat detection and warding off cyber attacks. The algorithms that are used utilize historical network data, so it can recognize the slightest indication of compromise. Machine learning models such as Random Forest and Support Vector Machines (SVM) have a 94.1\% and 92.3\% accuracy rate, respectively [1].

Another kind of architecture that’s critical to recognizing patterns is Deep Learning, specifically neural networks and long short-term memory. On a large dataset, a deep learning model achieved a 96.8\% accuracy rate in detecting threats such as ransomware and intrusion, outperforming the two ML models [1]. These deep learning models are effective in identifying polymorphic malware as well, which changes its code to try and hide from signature-based systems [4][5].
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\linewidth]{CS4750-figure1.png}
    \caption{Effectiveness of AI/ML in Vulnerability Detection.\\ (Image from Busireddy et al., 2025)}
...
While AI excels at detecting malicious activity, its most transformative potential lies in preventing attacks before they occur. By predicting which vulnerabilities and attack vectors are most likely to be exploited, AI-driven systems allow organizations to adopt a proactive cybersecurity posture, rather than a reactive posture.

Traditional vulnerability management relies heavily on manual scanning and static severity scoring systems such as the Common Vulnerability Scoring System (CVSS). However, these models often fail to account for real-time threat dynamics or contextual risk factors. AI enhances vulnerability management by analyzing historical breach data, exploited databases, and current threat intelligence to predict which vulnerabilities are most likely to be targeted by attackers [2][10]. Using machine learning algorithms, systems can assess exploit likelihood by identifying correlations between past exploitation trends, vulnerability age, and system exposure.
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\linewidth]{CS4750-figure3.png}
    \caption{WannaCry Ransomware attack code generation using ChatGPT\\
...
\bibitem{busireddy2025bigdata}
Busireddy, H. K., Nuka, S. T., Malempati, M., Sriram, H. K., Mashetty, S., \& Kannan, S. (2025).
\newblock Big data in cybersecurity: Enhancing threat detection with AI and ML.
\newblock {\em Metallurgical and Materials Engineering, 31}(3), 12--20.
\newblock \href{https://doi.org/10.63278/1315}{https://doi.org/10.63278/1315}

\bibitem{camacho2024role}
Camacho, N. G. (2024).
\newblock The role of AI in cybersecurity: Addressing threats in the digital age.
\newblock {\em Journal of Artificial Intelligence General Science (JAIGS), 3}(1), 143--154.
\newblock \href{https://doi.org/10.60087/jaigs.v3i1.75}{https://doi.org/10.60087/jaigs.v3i1.75}

\bibitem{gupta2023threatgpt}
Gupta, M., Akiri, C., Aryal, K., Parker, E., \& Praharaj, L. (2023).
\newblock From ChatGPT to ThreatGPT: Impact of generative AI in cybersecurity and privacy.
\newblock {\em IEEE Access, 11}, 80218--80245.
\newblock \href{https://doi.org/10.1109/ACCESS.2023.3300381}{https://doi.org/10.1109/ACCESS.2023.3300381}

\bibitem{hasanah2025malware}
Hasanah, N. I., Insany, G. P., Kharisma, I. L., \& Rahayu, N. D. (2025).
\newblock Recent advancements in machine learning models for malware detection: A systematic literature review.
\newblock {\em Engineering Proceedings, 107}(1), 78.
\newblock \href{https://doi.org/10.3390/engproc2025107078}{https://doi.org/10.3390/engproc2025107078}

\bibitem{khan2024aidetection}
Khan, M. I., Arif, A., \& Khan, A. R. A. (2024).
\newblock AI-driven threat detection: A brief overview of AI techniques in cybersecurity.
\newblock {\em BIN: Bulletin of Informatics, 2}(2), 248--261.
\newblock Available at \href{https://www.researchgate.net/publication/391613291_AI-Driven_Threat_Detection_A_Brief_Overview_of_AI_Techniques_in_Cybersecurity}{ResearchGate}

\bibitem{kimanzi2024deeplearning}
Kimanzi, R., Kimanga, P., Cherori, D., \& Gikunda, P. K. (2024).
\newblock Deep learning algorithms used in intrusion detection systems: A review.
\newblock {\em arXiv preprint arXiv:2402.17020}.
\newblock \href{https://arxiv.org/abs/2402.17020}{https://arxiv.org/abs/2402.17020}

\bibitem{kipchirchir2024phishing}
Kipchirchir, S., \& Odoyo, W. (2024).
\newblock AI-based phishing attack detection and prevention using natural language processing (NLP).
\newblock {\em IC-ITECHS, 5}(1), 597--602.
\newblock \href{https://doi.org/10.32664/ic-itechs.v5i1.1590}{https://doi.org/10.32664/ic-itechs.v5i1.1590}

\bibitem{rahman2025aiintegration}
Rahman, M. M., Dhakal, K., Md, N. G., Sd, M. K. S., \& Md, M. R. (2025).
\newblock AI integration in cybersecurity software: Threat detection and response.
\newblock {\em International Journal of Innovative Research and Scientific Studies, 8}(3), 3907--3921.
\newblock \href{https://doi.org/10.53894/ijirss.v8i3.7403}{https://doi.org/10.53894/ijirss.v8i3.7403}

\bibitem{shahana2024aidriven}
Shahana, A., Hasan, R., Farabi, S., Akter, J., Mahmud, M., Johora, F., \& Suzer, G. (2024).
\newblock AI-driven cybersecurity: Balancing advancements and safeguards.
\newblock {\em Journal of Computer Science and Technology Studies, 6}(2), 76--85.
\newblock \href{https://doi.org/10.32996/jcsts.2024.6.2.9}{https://doi.org/10.32996/jcsts.2024.6.2.9}

\bibitem{sontan2024intersection}
Sontan, A. D., \& Samuel, S. V. (2024).
\newblock The intersection of artificial intelligence and cybersecurity: Challenges and opportunities.
\newblock {\em World Journal of Advanced Research and Reviews, 21}(2), 1720--1736.
\newblock \href{https://doi.org/10.30574/wjarr.2024.21.2.0607}{https://doi.org/10.30574/wjarr.2024.21.2.0607}
